                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                                ...
                                                                <div class="col-5">
                                                                    <form wire:submit.prevent='wage'>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-5">
                                                                                <br>
                                                                                <button type='submit' class="btn btn-rounded waves-effect waves-light btn-primary">Tính lương</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-3">
                                                                    <br>
                                                                    <button wire:click='undoWage' class="btn btn-rounded waves-effect waves-light btn-secondary">Tính lại</button>
                                                                    <button wire:click='insertWage' class="btn btn-rounded waves-effect waves-light btn-success">Lưu lại</button>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-7"></div>
