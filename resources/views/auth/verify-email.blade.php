                ...
                <div class="card bg-pattern">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center w-75 m-auto">
                            <div class="auth-logo">
                                <h1 class='text-danger'> Đã gửi mail </h1>
                        ...
                        <div class="mt-3 text-center">
                            ...
                            <h3>Hoàn tất !</h3>
                            <p class="text-muted font-14 mt-2"> Một email xác nhận tài khoản đã được gửi cho <b>email của bạn</b>.
                                Vui lòng xác nhận để hoàn tất việc tạo tài khoản!</p>

                            <a href="https://mail.google.com/" class="btn w-100 btn-pink waves-effect waves-light mt-3">Đến email của bạn...</a>
                        </div>
